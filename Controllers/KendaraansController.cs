...
namespace RentalKendaraan.Controllers
{
    public class KendaraansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaKendaraan,NoPolisi,NoStnk,IdJenisKendaraan,Keseterdiaan")] Kendaraan kendaraan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKendaraan,NamaKendaraan,NoPolisi,NoStnk,IdJenisKendaraan,Keseterdiaan")] Kendaraan kendaraan)
        {
